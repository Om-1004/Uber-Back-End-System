  ...
  public static void main(String[] args)
  {
    ...
    while (scanner.hasNextLine())
    {
      ...
      else if (action.equalsIgnoreCase("REQRIDE")) 
      {
        ...
        boolean validRequest = tmuber.requestRide(accountId, from, to); 
        if (validRequest){ // if its a valid request print out the Ride
      ...
      else if (action.equalsIgnoreCase("REQDLVY")) 
      {
        ...
        boolean validRequest = tmuber.requestDelivery(accountId, from, to, restaurant, order);
        if (validRequest){ // if its a valid request print out the Delivery
